...
CarPositionFuser::PosSample CarPositionFuser::getClosestPosFusedSampleInTime(int msecsSinceStartOfDay)
{
...
void CarPositionFuser::correctPositionAndYawGNSS(QSharedPointer<VehicleState> vehicleState, double distanceMoved, bool fused)
{
...
void CarPositionFuser::setPosGNSSxyGain(double posGNSSxyGain)
{
    mPosGNSSxyGain = posGNSSxyGain;
}


void CarPositionFuser::setPosGNSSyawGain(double posGNSSyawGain)
{
